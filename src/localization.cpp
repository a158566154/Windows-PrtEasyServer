...
StringMap BuildBaseEnglishStrings() {
    return {
        ...
        {L"label_display_name", L"Client printer name"},
        ...
        {L"column_display_name", L"Client name"},
        ...
        {L"message_duplicate_display_name", L"Each client printer name must be unique."},
        ...
        {L"installer_error_download_driver", L"Unable to download the driver package: "},
...
StringMap BuildBaseTraditionalChineseStrings() {
    return {
        ...
        {L"label_display_name", L"用戶端印表機名稱"},
        ...
        {L"message_duplicate_display_name", L"每個用戶端印表機名稱都必須不同。"},
        ...
        {L"installer_error_download_driver", L"無法下載驅動程式套件："},
...
StringMap BuildBaseSimplifiedChineseStrings() {
    return {
        ...
        {L"label_display_name", L"客户端打印机名称"},
        ...
        {L"message_duplicate_display_name", L"每个客户端打印机名称必须唯一。"},
        ...
        {L"installer_error_download_driver", L"无法下载驱动程序包："},
